...
# 导入游戏服务和UI组件
from ..services.ghost_card_service import ghost_card_service
from ..ui.ghost_card_ui import GhostCardUI
from ..ui.confirm_draw_modal import DrawConfirmationView
from ..ui.bet_view import BetView

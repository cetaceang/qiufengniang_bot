...
class BetView(discord.ui.View):
    ...
    @discord.ui.button(label="下注 20", style=discord.ButtonStyle.primary, custom_id="bet_20")
    async def bet_20_button(self, interaction: discord.Interaction, button: discord.ui.Button):
